...
export default function MapLegend({ mapType }: Props) {
    ...
    return (
        <div className="absolute top-4 right-4 z-1000 flex w-96 flex-col gap-4 rounded-xl border border-accent/70 bg-background/50 p-4 shadow-lg">
            ...
            <div
                ...
                className="h-6 w-full rounded-xl border border-accent/70"
            />
